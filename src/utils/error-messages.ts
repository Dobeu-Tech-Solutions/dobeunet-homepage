...
export const commonErrors = {
  ...
  offline: (): ErrorMessage => ({
    ...
    message:
      "Some features require an internet connection. Your changes will be saved when you reconnect.",
  ...
  sessionExpired: (): ErrorMessage => ({
    ...
    message:
      "Your session has expired for security. Any unsaved changes have been preserved.",
